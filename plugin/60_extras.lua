...
MiniDeps.later(function()
	MiniDeps.add("ahkohd/buffer-sticks.nvim")

	require("buffer-sticks").setup({
		highlights = {
			active = { link = "Constant" },
			alternate = { link = "LineNr" },
			inactive = { link = "NonText" },
			active_modified = { link = "Constant" },
			alternate_modified = { link = "LineNr" },
			inactive_modified = { link = "ErrorMsg" },
			label = { link = "Comment" },
			filter_selected = { link = "ErrorMsg" },
			filter_title = { link = "Comment" },
			list_selected = { link = "ErrorMsg" },
		},
	...
	vim.keymap.set(
		"n",
		"<leader>j",
		function() require("buffer-sticks").jump() end,
		{ desc = "Jump to buffer", noremap = false, silent = true }
	)

	vim.keymap.set(
		"n",
		"<leader>J",
		function() require("buffer-sticks").toggle() end,
		{ desc = "Toggle buffer sticks", noremap = false, silent = true }
	)
end)
